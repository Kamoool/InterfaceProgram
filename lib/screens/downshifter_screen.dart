...
class DownshifterScreenWidget extends StatefulWidget {
  ...
  const DownshifterScreenWidget(
      {Key? key, required this.settingsRepository, required this.notifyParent, required this.sendBlipCommand})
      : super(key: key);
                ...
                children: [
                        ...
                        builder: (BuildContext context, TapDebouncerFunc? onTap){
                          return ElevatedButton(
                            ...
                            child: onTap == null? const Text(
                              ...
                              'Blip', style: TextStyle(color: Colors.white, fontSize: 25),
                            ),
                  ...
                  Padding(
                    ...
                    child: NumericSettingWidget(
                        ...
                        maxAllowed: (double.tryParse(widget.settingsRepository.maxRPMDS.value)??widget.settingsRepository.maxRPMNumericMax) - 500,
                  ...
                  Padding(
                    ...
                    child: NumericSettingWidget(
                        ...
                        notifyParent: widget.notifyParent,
                        minAllowed: (double.tryParse(widget.settingsRepository.minRPMDS.value)?? widget.settingsRepository.minRPMNumericMin) + 500,
